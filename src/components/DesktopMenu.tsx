...
const DesktopMenu = () => {
  ...
  return (
    <section className='hidden md:flex flex-row items-center justify-between'>
      <button data-testid="desktop-portfolio-button" onClick={() => setPage('portfolio')} className="relative group hover:cursor-pointer font1">
      ...
      <button data-testid="desktop-resume-button" onClick={() => setPage('resume')} className="relative group hover:cursor-pointer font1">
      ...
      <Logo />
      <button data-testid="desktop-about-button" onClick={() => setPage('about')} className="relative group hover:cursor-pointer font1">
      ...
      <button data-testid="desktop-contact-button" onClick={() => setPage('contact')} className="relative group hover:cursor-pointer font1">
