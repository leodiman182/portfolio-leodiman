  ...
  return (
    <section className='flex flex-row items-center justify-between md:hidden'>
      ...
      <nav className='z-20 items-center'>
        <button data-testid="mobile-menu-button" onClick={() => {setOpenMenu(!openMenu)}}>
          {
            openMenu ? (
        ...
        <article id='mobile-menu' className='bg-black fixed top-[65px] left-0 w-screen h-full p-[25px] overflow-y-hidden z-10 dropdown_menu'>
          <button data-testid="mobile-portfolio-button" onClick={() => setPage('portfolio')} className="relative group hover:cursor-pointer font1 text-[35px] py-[15px]">
          ...
          <button data-testid="mobile-resume-button" onClick={() => setPage('resume')} className="relative group hover:cursor-pointer font1 text-[35px] py-[15px]">
          ...
          <button data-testid="mobile-about-button" onClick={() => setPage('about')} className="relative group hover:cursor-pointer font1 text-[35px] py-[15px]">
          ...
          <button data-testid="mobile-contact-button" onClick={() => setPage('contact')} className="relative group hover:cursor-pointer font1 text-[35px] py-[15px]">
