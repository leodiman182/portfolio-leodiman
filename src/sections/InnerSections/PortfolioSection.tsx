    ...
    <section className="pb-[100px]">      
      {
        selectedProject.name === '' ? (
          ...
          <div className='flex flex-col items-center justify-center xl:w-[1000px] w-full'>
            ...
            <div className='md:px-[120px] py-[50px]'>
            ...
            <div className='w-full flex flex-col items-center justify-center'>
              ...
              <div className="flex flex-row items-center justify-between w-full md:w-[100px] h-[45px] mt-[10px] mb-[45px]">
            ...
            <div className='w-full flex flex-col items-end justify-center'>
              <img className='w-full h-[500px] object-top object-cover overflow-y-scroll' src={ selectedProject.image } alt={ selectedProject.name } />
              {
